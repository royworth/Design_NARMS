...
```{r prior_psi_logodds_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
...
```{r prior_psi_prob, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
...
```{r prior_psi_prob_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_sigma_gamma_psi_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
...
```{r prior_sigma_gamma_psi_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_sigma_delta_psi_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
ggplot(tibble(x = seq(0, 2, 0.01), 
              y = dtruncnorm(seq(0, 2, 0.01), 
                             a = 0, 
...
Here are our simulated draws for this prior on the probability scale.
```{r prior_sigma_delta_psi_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_sigma_nu_psi_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
ggplot(tibble(x = seq(0, 2, 0.01), 
              y = dtruncnorm(seq(0, 2, 0.01), 
                             a = 0, 
...
Here are our simulated draws for this prior on the probability scale.
```{r prior_sigma_nu_psi_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_theta_logodds_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
...
```{r prior_theta_prob, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
...
```{r prior_theta_prob_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_sigma_gamma_theta_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
ggplot(tibble(x = seq(0, 2, 0.01), 
              y = dtruncnorm(seq(0, 2, 0.01), 
                             a = 0, 
...
Here are our simulated draws for this prior on the probability scale.
```{r prior_sigma_gamma_theta_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_sigma_delta_theta_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
ggplot(tibble(x = seq(0, 2, 0.01), 
              y = dtruncnorm(seq(0, 2, 0.01), 
                             a = 0, 
...
Here are our simulated draws for this prior on the probability scale.
```{r prior_sigma_delta_theta_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_sigma_nu_theta_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
ggplot(tibble(x = seq(0, 2, 0.01), 
              y = dtruncnorm(seq(0, 2, 0.01), 
                             a = 0, 
...
Here are our simulated draws for this prior on the probability scale.
```{r prior_sigma_nu_theta_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_p_logodds_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
...
```{r prior_p_prob, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
...
And, finally, our simulated draws from this prior on the probability scale.
```{r prior_p_prob_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_sigma_gamma_p_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
ggplot(tibble(x = seq(0, 2, 0.01), 
              y = dtruncnorm(seq(0, 2, 0.01), 
                             a = 0, 
...
Here are our simulated draws for this prior on the probability scale.
```{r prior_sigma_gamma_p_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_sigma_delta_p_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
ggplot(tibble(x = seq(0, 2, 0.01), 
              y = dtruncnorm(seq(0, 2, 0.01), 
                             a = 0, 
...
Here are our simulated draws for this prior on the probability scale.
```{r prior_sigma_delta_p_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r prior_sigma_nu_p_plot, fig.align='center', fig.width=4, fig.asp=0.75}
# plot it
ggplot(tibble(x = seq(0, 2, 0.01), 
              y = dtruncnorm(seq(0, 2, 0.01), 
                             a = 0, 
...
Here are our simulated draws for this prior on the probability scale.
```{r prior_sigma_nu_p_draws, fig.align='center', fig.width=4, fig.asp=0.75, warning=F}
# plot it
...
```{r distribution_occupancy_days, fig.align='center', fig.width=8, fig.asp=1, warning=FALSE}
...
```{r distribution_occupancy_sites, fig.align='center', fig.width=8, fig.asp=1}
...
```{r distribution_pcr_detects, fig.align='center', fig.width=6, fig.asp=0.75, warning=FALSE}
...
```{r frequency_plot, fig.width= 10, fig.asp=2, fig.align='center'}
plot(plot_out)
```
...
```{r frequency_plot_fix, fig.width= 10, fig.asp = 2, fig.align='center'}
plot(plot_out)
```
...
## Stan code
Thanks to Maxwell Jospeph for providing the first marginalized version of a multilevel occupancy model useable with Stan that I came across at:
...
```{r plotting_params, fig.align='center', fig.width=6, fig.asp=0.75}
